...
# Logging parameters
RUN_NAME = "GPT_XTTS_v2.0_QASR_FT"
...
DATA_PATH = "/home/chiyu.zhang/tts/work_dir/aratts/TTS/recipes/qasr/xtts_v2/data"
DEBUG = False
...
def main():
    if DEBUG:
        ...
        test_sentences = [
            {
                "text": "قرر الرئيس محمد حسني مبارك تخليه عن منصب رئيس الجمهورية ..",
