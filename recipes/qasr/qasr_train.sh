...
manifests_dir="/home/chiyu.zhang/tts/work_dir/aratts/TTS/recipes/qasr/test_mp"
...
if [ $multi_gpu == true ]; then
  CUDA_VISIBLE_DEVICES="0,1,2,3" python -m trainer.distribute --gpus "0,1,2,3" --script train_yourtts.py
else
  CUDA_VISIBLE_DEVICES="0" python train_yourtts.py
fi